...
export default function FormStepper({ step }: { step: 'input' | 'confirm' | 'success' | 'error' }) {
  return (
    <ol className={styles.stepper}>
      <li
        className={clsx(styles.stepperItem, step === 'input' && styles.stepperItemCurrent)}
      ...
      <li
        className={clsx(styles.stepperItem, step === 'confirm' && styles.stepperItemCurrent)}
      ...
      <li
        className={clsx(styles.stepperItem, step === 'success' && styles.stepperItemCurrent)}
